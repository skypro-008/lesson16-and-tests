...
# 1. Напишите метод get_all() модели User который будет возвращать все объекты из базы
# 2. Напишите метод get_one() модели User, который будет принимать аргумент id и
